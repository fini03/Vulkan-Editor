    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex
        ...
        void createGraphicsPipeline(VkDevice device, VkRenderPass renderPass
            , VkDescriptorSetLayout descriptorSetLayout, Pipeline& graphicsPipeline) {
                auto vertShaderCode = readFile("/home/misa/university/SS25/P1/Vulkan-Editor/shaders/vert.slang");
        auto fragShaderCode = readFile("/home/misa/university/SS25/P1/Vulkan-Editor/shaders/frag.slang");
