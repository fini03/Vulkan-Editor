...
const std::string m_MODEL_PATH = "path/to/model";
const std::string m_TEXTURE_PATH = "path/to/texture";
...
class VulkanTutorial {
    ...
    void createGraphicsPipeline(VkDevice device, VkRenderPass renderPass, VkDescriptorSetLayout descriptorSetLayout, Pipeline& graphicsPipeline) {
        auto vertShaderCode = readFile("path/to/shader.vert");
        auto fragShaderCode = readFile("path/to/shader.frag");
